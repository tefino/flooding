...
void Domain::writeClickFiles(bool montoolstub) {
    ...
    for (int i = 0; i < network_nodes.size(); i++) {
        ...
        {
            cerr<<"Right now only work under mac"<<endl ;
        }
        ...
        /*Our proposal add new connections*/
        if(unique_ifaces.size() >1)
        {
        ...
        click_conf<<"proxy[4]->[4]fw;"<<endl ;
        click_conf<<"proxy[5]->[5]fw;"<<endl ;

        click_conf<<"cacheunit[1]->[1]fw;"<<endl ;
        click_conf<<"cacheunit[2]->[0]fw;"<<endl ;
        ...
        click_conf<<"fw[4]->[4]proxy;"<<endl ;
        click_conf<<"fw[5]->[3]cacheunit;"<<endl ;
        click_conf<<"proxy[6]->[6]fw;"<<endl ;
        click_conf<<"cacheunit[4]->[7]fw;"<<endl ;
        click_conf<<"classifier[4]->[8]fw;"<<endl ;
        click_conf<<"cacheunit[5]->[9]fw;"<<endl ;
        click_conf.close();
    }
}
